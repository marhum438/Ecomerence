...
import 'package:flutter_application_1/view/components/custom_container.dart';
import 'package:flutter_application_1/view/components/star_icon_widget.dart';
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Spacer(),
                    Icon(Icons.square_outlined, color: Colors.grey[400]),
                    SizedBox(
                      width: 10,
                    ),
                    Text("with photo",
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                      "The dress is great! Very Classy and\nconfortable. It fit perfectly! I`m 5`7` and\n130 pound. I am a 38B chest. this dress\nwould be too long for those who are shorter\nbut could be hemmed.I would not \n recommend it for those big chested as I am\nsmaller chested and it fit me perfectly.the \nunderams were not too wide and dress\n was made well",style: TextStyle(fontSize: 13),),
                                ],
                              ),
                              Spacer(),
                              Row(
